...
pncNB_int_everu5 <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_countu5 <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_everInf <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_countInf <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_everNeo <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_countNeo <- function(IRdata, restrictBord = NULL) {
...
pncNB_int_everB4Dur <- function(IRdata, restrictBord = NULL) {

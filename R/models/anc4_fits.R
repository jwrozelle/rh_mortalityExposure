...
anc4_everu5 <- function(IRdata, restrictBord = NULL) {
...
anc4_countu5 <- function(IRdata, restrictBord = NULL) {
...
anc4_everInf <- function(IRdata, restrictBord = NULL) {
...
anc4_countInf <- function(IRdata, restrictBord = NULL) {
...
anc4_everNeo <- function(IRdata, restrictBord = NULL) {
...
anc4_countNeo <- function(IRdata, restrictBord = NULL) {
...
anc4_everB4Dur <- function(IRdata, restrictBord = NULL) {
